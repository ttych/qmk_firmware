...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FNC] = LAYOUT_60_ansi(
        ...
        _______,            _______, _______, _______, KC_MUTE, _______, _______, KC_MUTE, KC_VOLD, KC_VOLU,  KC_BTN3,            _______,
    ...
    [_FN] = LAYOUT_60_ansi(
        ...
        _______,            _______, _______, _______, KC_MUTE, _______, RGB_HUD, RGB_SAD, RGB_VAD, RGB_SPD,  RGB_RMOD,           _______,
        _______,  _______,  _______,                            _______,                            _______,  MO(_FN),  KC_APP,   NK_TOGG)
