...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN] = LAYOUT_60_ansi(
        KC_GRV,   KC_F1,    KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,   KC_F11,   KC_F12,   KC_DEL,
        KC_F13,   KC_PGUP,  KC_UP,   KC_PGDN, KC_HOME, RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, RGB_SPI, KC_PSCR,  KC_SCRL,  KC_PAUS,  KC_INS,
        KC_CAPS,  KC_LEFT,  KC_DOWN, KC_RGHT, KC_END, RGB_RMOD, RGB_HUD, RGB_SAD, RGB_VAD, RGB_SPD, _______,  _______,            RGB_TOG,
        _______,            _______, RGB_M_P, RGB_M_SW, RGB_M_R, RGB_M_B, _______, KC_MUTE, KC_VOLD, KC_VOLU, _______,            KC_MUTE,
