...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [15] = LAYOUT_60_ansi(
                          ...
                          KC_F13, KC_PGUP, KC_UP, KC_PGDN, KC_HOME, KC_BRIU, KC_NO, KC_NO, KC_NO, KC_NO, KC_PSCR, KC_SLCK, KC_PAUS, RGB_M_R,
                          KC_TRNS, KC_LEFT, KC_DOWN, KC_RGHT, KC_END, KC_BRID, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_INS, RGB_TOG,
                          KC_LSFT, RGB_M_B, RGB_M_SN, TO(0), TO(1), TO(2), TO(3), TO(4), TO(5), TO(6), TO(7), KC_MUTE,
